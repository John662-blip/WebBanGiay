...
<%
    ...
    String form_value = "null";
    // Retrieve data from the session
    try {
        form_value = (String) session1.getAttribute("form");
        session1.removeAttribute("form");
    }
    catch(Exception e){}
%>
...
<div class="container">
    <header>
        <div class="header-content">
            ...
            <div class="search-and-icons" style="margin-right: 50px">
                <a href="/logout">
                    <div>Đăng xuất</div>
                </a>
            </div>
    ...
    <div class="main-content">
        <aside class="sidebar">
            <ul>
                ...
                <li style="display: none" ><a href="#" id="account-management-btn">Quản lý tài khoản khách hàng</a></li>
                <li ><a href="#" id="order-management-btn">Quản lý đơn hàng</a></li>
                <li style="display: none" ><a href="#" id="promotion-management-btn">Quản lý khuyến mãi</a></li>
            ...
            <div class="product-management" id="product-management" >
                <div class="product-management-header">
                    ...
                    <div class="product-management-actions">
                        ...
                        <button style="display: none" class="action-btn" id="btn-product-management-actions-edit">Sửa</button>
                        <button style="display: none" class="action-btn" id="btn-product-management-actions-delete">Xóa</button>
                    </div>
            ...
            <div class="category-management" id="category-management">
                <div class="category-management-header">
                    ...
                    <div class="category-management-actions">
                        ...
                        <button style="display: none" class="action-btn" id="btn-category-management-actions-delete">Xóa</button>
                    ...
                    <form action="CategoryController" method="post" >
                        <div class="category-management-form" id="delete-category-management-form">
                            ...
                            <button style="display: none" class="action-btn" name="submitAction" value="delete-category">Xóa danh mục</button>
                        </div>
                    </form>
                </div>
            </div>
...
<script src="${pageContext.request.contextPath}/js/promotion.js" ></script>
<script src="${pageContext.request.contextPath}/js/admin.js"></script>
<script
        src="${pageContext.request.contextPath}/js/statistics.js" ></script>
<script>
    ...
    switch (value){
        case "0":
            ...
            break
        case "1":
            document.getElementById("manage-categrories-btn").click();
            break
        case "2":
            document.getElementById("order-management-btn").click();
            break;
        default:
            document.getElementById("manage-products-btn").click();
            break;
