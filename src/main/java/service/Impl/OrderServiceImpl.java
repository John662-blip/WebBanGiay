...
public class OrderServiceImpl implements IOrderService {
    ...
    @Override
    public boolean CreateOrderTWP(String json, int idUser, int total, int discount, int feeShip) {
        String orderId = LocalDateTime.now().toString();
        int amount = total;
        JSONArray ListJsonCartItem = new JSONArray(json);
