...
<section >
    <nav>
        ...
        <div class="icons">
            <i onclick="redirectToSearchPage()" class="fa-solid fa-magnifying-glass" style="font-size: 30px; margin-left: 15px; position: relative;"></i>
                    ...
                    <c:otherwise>
                         <span class="user-icon">
                            ...
                            <div class="dropdown-menu">
                                <a href="/customer/orders">Lịch sử mua hàng</a>
